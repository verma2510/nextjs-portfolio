                        ...
                        <div className="p-lg-5 p-md-4 p-3 border border-1 mt-5 bg-3">
                          <div className="row">
                            ...
                            <div className="col-lg-7 ps-lg-5 mt-5 mt-lg-0">
                              <h4 className="text-linear-4">Discover Dish</h4>
                              <ul>
                                <li>
                                  Developed a Recipe Finder application using
                                  React and Redux.
                                </li>
                                <li>
                                  Integrated with a public API to fetch and
                                  display recipes.
                                </li>
                                <li>
                                  Enabled users to search for recipes, save
                                  their favorites, and manage them on a
                                  dedicated page.
                                </li>
                                <li>
                                  Implemented state management with Redux for
                                  seamless addition and removal of favorite
                                  recipes.
                                </li>
                                <li>
                                ...
                                <li>
                                  Utilized React Router for efficient
                                  navigation.
                                </li>
                              </ul>
                              <ul className="mt-4 list-unstyled">
                                ...
                                <li className="text-dark mb-3 border-bottom pb-3">
                                  <div className="d-flex justify-content-between">
                                    ...
                                    <p className="text-300 mb-0 text-end">
                                      Public API, React, Redux, React Router,
                                      Netlify
                                    </p>
                                  </div>
                                </li>
                              ...
                              <div className="d-flex flex-wrap align-items-center gap-3 mt-7">
                                <Link
                                  href="https://discover-dish.netlify.app/"
                                ...
                                <Link
                                  href="https://github.com/verma2510/discover-dish"
                                  className="text-300 border-bottom border-1 px-2 pb-2 link-hover"
                                >
                                  <svg
                                    xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div className="p-lg-5 p-md-4 p-3 border border-1 mt-5 bg-3">
                          <div className="row">
                            ...
                            <div className="col-lg-7 ps-lg-5 mt-5 mt-lg-0">
                              ...
                              <ul>
                                <li>
                                  Built an interactive, data-driven frontend
                                  application using ReactJS for banking
                                  analytics.
                                </li>
                                <li>
                                  Executed React hooks, such as useState, to
                                  manage component states effectively, improving
                                  interactivity and data handling within the
                                  application.
                                </li>
                                <li>
                                  Developed dynamic modules to display essential
                                  financial metrics and reusable components like
                                  Navbar, Button, Chart, Sidebar, and
                                  Transaction view.
                                </li>
                                <li>
                                  These enhancements improved readability and
                                  code reusability.
                                </li>
                                <li>
                                  Integrated React Router to facilitate seamless
                                  navigation across various sections.
                                </li>
                                <li>
                                  Deployed the application on Netlify for secure
                                  and high-availability access.
                                </li>
                              </ul>
                              ...
                              <ul className="mt-4 list-unstyled">
                                ...
                                <li className="text-dark mb-3 border-bottom pb-3">
                                  <div className="d-flex justify-content-between">
                                    ...
                                    <p className="text-300 mb-0 text-end">
                                      React, MUI Charts, React Router, Netlify
                                    </p>
                                  </div>
                                </li>
                              </ul>
                              <div className="d-flex flex-wrap align-items-center gap-3 mt-7">
                                <Link
                                  href="https://finance-dashboard-reactjs.netlify.app/"
                                  className="text-300 border-bottom border-1 px-2 pb-2 link-hover"
                                >
                                  <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                ...
                                <Link
                                  href="https://github.com/verma2510/finance-dashboard"
                                  className="text-300 border-bottom border-1 px-2 pb-2 link-hover"
                                >
                                  <svg
                                    xmlns="http://www.w3.org/2000/svg"
